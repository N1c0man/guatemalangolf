  ...
  return (
    <Link
      ...
      className={[
        ...
        "after:bg-gradient-to-r after:from-transparent after:via-gg-ember/80 after:to-transparent",
    ...
    >
      ...
      <span className="relative shrink-0">
        {/* Slow ember pulse halo */}
        <span
          aria-hidden="true"
          className={[
            "absolute inset-0 rounded-xl",
            "bg-gg-ember/10 blur-md",
            "animate-emberPulse",
          ].join(" ")}
        />
        ...
        <img
          ...
          className={[
            ...
            "group-hover:drop-shadow-[0_0_22px_rgba(255,106,0,0.55)]",
          ].join(" ")}
        />
      </span>
      ...
      <span className="min-w-0 leading-tight">
        <span className="block truncate text-white font-semibold tracking-[0.16em] uppercase text-[13px] sm:text-sm">
          Guatemalan
        </span>
